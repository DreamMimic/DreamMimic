...
class InterMimic_All(InterMimic):
    ...
    def __init__(self, cfg, sim_params, physics_engine, device_type, device_id, headless):
        ...
        self.hoi_data = self._load_motion(self.motion_file, startk=1, topk=self.psi)
        self.hoi_data_retarget = self._load_motion(self.motion_file_retarget, startk=1, topk=self.psi)
        return
