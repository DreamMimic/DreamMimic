...
# Run script for World Model integrated distillation
...
from learning import intermimic_agent_distill_wm
from learning import intermimic_players_distill
from learning import intermimic_models
from learning import intermimic_network_builder_wm
...
def build_alg_runner(algo_observer):
    ...
    # Register World Model agent and network builder
    runner.algo_factory.register_builder('intermimic_wm', lambda **kwargs : intermimic_agent_distill_wm.InterMimicAgentDistillWM(**kwargs))
    ...
    runner.player_factory.register_builder('intermimic_wm', lambda **kwargs : intermimic_players_distill.InterMimicPlayerContinuousDistill(**kwargs))
    runner.model_builder.model_factory.register_builder('intermimic_wm', lambda network, **kwargs : intermimic_models.ModelInterMimicContinuous(network))  
    runner.model_builder.network_factory.register_builder('intermimic_wm', lambda **kwargs : intermimic_network_builder_wm.InterMimicBuilderWM(**kwargs))
