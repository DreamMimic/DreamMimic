...
from env.tasks.intermimic_all_goalpose_vis_student_obs_wm import InterMimic_All_GoalPose_Vis_StudentObs_WM
...
def create_rlgpu_env(**kwargs):
    ...
    task = InterMimic_All_GoalPose_Vis_StudentObs_WM(
        cfg=cfg,
